...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Shubham Mishra</h2>;
  const three = <h3 className="big-heading">A Deep Learning Enthusiast.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      href={`mailto:mishra4475@gmail.com`} className="email-link">
      Contact Me!
    </a>
  );
